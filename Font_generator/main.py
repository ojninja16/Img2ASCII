...
if __name__ == "__main__":
    ...
    font_size = 20
    #-------------------------------------------------------------
    output_image_path = "../data/ascii_art_images"
    ...
    #     ascii_art,original_shape=main(img_path)
    #     ascii_image=render_ascii_art(ascii_art,original_shape, font_path, font_size,os.path.join(output_image_path,img))
